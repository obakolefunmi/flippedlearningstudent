...
namespace Flippedstudent.Class
{
    class Common
    {
        ...
        private static String PROFILE_COLLECTION_NAME = "studentprofile";
        private static String COURSES_COLLECTION_NAME = "studentcourses";
        ...
        public static string getAddresApiCoursesspecifictitle(string lecturer)
        {
            String baseUrl = $"https://api.mlab.com/api/1/databases/{DB_NAME}/collections/{COURSES_COLLECTION_NAME}";
            StringBuilder stringBuilder = new StringBuilder(baseUrl);
            stringBuilder.Append("?q={student:" + lecturer + "}&apiKey=" + API_KEY);
            return stringBuilder.ToString();
        }
        //Lectures
        ...
        public static string getAddresApiEvaluationspecific(string title)
        {
            String baseUrl = $"https://api.mlab.com/api/1/databases/{DB_NAME}/collections/{EVALUATION_COLLECTION_NAME}";
            StringBuilder stringBuilder = new StringBuilder(baseUrl);
            stringBuilder.Append("?q={title:" + title + "}&apiKey=" + API_KEY);
            return stringBuilder.ToString();
        }
        //Student Evaluation
        ...
        public static string getAddresApiStudentEvaluation()
        {
            String baseUrl = $"https://api.mlab.com/api/1/databases/{DB_NAME}/collections/{STUDENT_EVAL_COLLECTION_NAME}";
            StringBuilder stringBuilder = new StringBuilder(baseUrl);
            stringBuilder.Append("?apiKey=" + API_KEY);
