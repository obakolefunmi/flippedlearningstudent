...
{
    [Activity(Label = "EditProfileActivity", Theme = "@style/Theme.Custom")]
    public class EditProfileActivity : AppCompatActivity
    {
        ...
        public TextView editemail, editstaffid, editcollege, editdepartment, edittextEdit, editProgram;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            editProgram = FindViewById<TextView>(Resource.Id.editProgram);
